...
public class Test extends Contract {
    public static String BINARY = "";
    ...
    public RemoteCall<TransactionReceipt> test(BigInteger a, BigInteger b) {
    ...
    public void test(BigInteger a, BigInteger b, TransactionSucCallback callback) {
        final Function function = new Function(
                FUNC_TEST, 
                Arrays.<Type>asList(new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(a), 
                new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(b)), 
    ...
    public String testSeq(BigInteger a, BigInteger b) {
        final Function function = new Function(
                FUNC_TEST, 
                Arrays.<Type>asList(new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(a), 
                new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(b)), 
    ...
    public Tuple2<BigInteger, BigInteger> getTestInput(TransactionReceipt transactionReceipt) {
